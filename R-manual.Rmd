...
In order to download the RStudio visit <https://rstudio.com> and download the RStudio Desktop free open source edition for your system. This edition includes all the features of the program, the difference with the pro version is the dedicated support and commercial licence.
